...
vec4 CalcPointLights() 
{
	...
	{
		vec3 direction = FragPos - pointLights[i].position; // get the vector from point light to fragment = direction
...
{									
	...
	finalColour += CalcPointLights(); // ambiant + diffuse + specular combination
